-- Inserting Data intop table    to add data into table we use insert into 
-- there are two possible ways 1) insert data without specifying column name and 2) with specifying Column Name 
-- 2) is more safer and readable
select * from users;
-- Insert into users values 
-- (1,"Harshal","hspatil9921@gmasil.com","male","2005-04-16",default);
...
INSERT INTO users (name, email, gender, date_of_birth) VALUES
('arlie', 'charlie23@example.com', 'Other', '1988-02-17'),
...
Insert into users values 
(4,"Rahul","rbpatil9921@gmasil.com","male","2003-05-16",75000,default);

INSERT INTO users (name, email, gender, date_of_birth, salary) VALUES
('Harshal', 'Harshalv@example.com', 'Male', '2005-04-16', 65000.00)
