...
--select * from Customers           -- for all customers 
--inner join orders
--on customers.customerid=orders.CustomerID;
select  customername from Customers   -- only customer names you can use distinct before column name to avoid repwtition
inner join orders
